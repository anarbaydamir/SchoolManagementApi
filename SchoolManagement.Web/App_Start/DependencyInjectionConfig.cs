...
namespace SchoolManagement.Web.App_Start
{
    public static class DependencyInjectionConfig
    {
        public static void Register()
        {
            ...
            builder.RegisterType<AssignmentMapper>().InstancePerLifetimeScope();
            builder.RegisterType<AssignmentAnswerMapper>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<AssignmentAnswerService>().As<IAssignmentAnswerService>().InstancePerRequest();
